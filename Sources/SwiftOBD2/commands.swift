...
public enum OBDCommand: Codable, Hashable, Comparable {
  ...
  public enum Mode9: CaseIterable, Codable, Comparable {
    ...
    var properties: CommandProperties {
      ...
      case .CALIBRATION_ID_MESSAGE_COUNT:
        return CommandProperties("0903", "Calibration ID message count for PID 04", 3, .count)
...
extension OBDCommand.General {
  public var properties: CommandProperties {
    ...
    case .ATIGN: return CommandProperties("ATIGN", "Ignition", 5, .none)
...
extension OBDCommand.Mode1 {
  var properties: CommandProperties {
    ...
    case .coolantTemp:
      return CommandProperties("0105", "Coolant temperature", 2, .temp, true, maxValue: 215, minValue: -40)
    case .shortFuelTrim1:
      return CommandProperties("0106", "Short Term Fuel Trim - Bank 1", 2, .percentCentered, true)
    case .longFuelTrim1:
      return CommandProperties("0107", "Long Term Fuel Trim - Bank 1", 2, .percentCentered, true)
    case .shortFuelTrim2:
      return CommandProperties("0108", "Short Term Fuel Trim - Bank 2", 2, .percentCentered, true)
    case .longFuelTrim2:
      return CommandProperties("0109", "Long Term Fuel Trim - Bank 2", 2, .percentCentered, true)
    case .fuelPressure:
      return CommandProperties("010A", "Fuel Pressure", 2, .fuelPressure, true, maxValue: 765)
    case .intakePressure:
      return CommandProperties("010B", "Intake Manifold Pressure", 3, .pressure, true, maxValue: 255)
    case .rpm: return CommandProperties("010C", "RPM", 3, .uas(0x07), true, maxValue: 8000)
    case .odometer: return CommandProperties("01A6", "Odometer reading", 5, .uas(0x25), true, minValue: 0)
    case .speed: return CommandProperties("010D", "Vehicle Speed", 2, .uas(0x09), true, maxValue: 280)
    case .timingAdvance:
      return CommandProperties("010E", "Timing Advance", 2, .timingAdvance, true, maxValue: 64, minValue: -64)
    ...
    case .cThrottlePos:
      return CommandProperties("0111", "Throttle Position (Calibrated)", 2, .percent, true)  // Calibrated later -- hacky right now
    ...
    case .O2Bank1Sensor1:
      return CommandProperties(
        "0114", "O2: Bank 1 - Sensor 1 Voltage", 3, .sensorVoltage, true, maxValue: 1.275)
    case .O2Bank1Sensor2:
      return CommandProperties(
        "0115", "O2: Bank 1 - Sensor 2 Voltage", 3, .sensorVoltage, true, maxValue: 1.275)
    case .O2Bank1Sensor3:
      return CommandProperties(
        "0116", "O2: Bank 1 - Sensor 3 Voltage", 3, .sensorVoltage, true, maxValue: 1.275)
    case .O2Bank1Sensor4:
      return CommandProperties(
        "0117", "O2: Bank 1 - Sensor 4 Voltage", 3, .sensorVoltage, true, maxValue: 1.275)
    case .O2Bank2Sensor1:
      return CommandProperties(
        "0118", "O2: Bank 2 - Sensor 1 Voltage", 3, .sensorVoltage, true, maxValue: 1.275)
    case .O2Bank2Sensor2:
      return CommandProperties(
        "0119", "O2: Bank 2 - Sensor 2 Voltage", 3, .sensorVoltage, true, maxValue: 1.275)
    case .O2Bank2Sensor3:
      return CommandProperties(
        "011A", "O2: Bank 2 - Sensor 3 Voltage", 3, .sensorVoltage, true, maxValue: 1.275)
    case .O2Bank2Sensor4:
      return CommandProperties(
        "011B", "O2: Bank 2 - Sensor 4 Voltage", 3, .sensorVoltage, true, maxValue: 1.275)
    ...
    case .auxInputStatus:
      return CommandProperties("011E", "Auxiliary input status (power take off)", 2, .auxInputStatus)
    ...
    case .fuelRailPressureVac:
      return CommandProperties("0122", "Fuel Rail Pressure (relative to vacuum)", 4, .uas(0x19), true)
    case .fuelRailPressureDirect:
      return CommandProperties("0123", "Fuel Rail Pressure (direct inject)", 4, .uas(0x1B), true)
    case .O2Sensor1WRVolatage:
      return CommandProperties(
        "0124", "02 Sensor 1 WR Lambda Voltage", 6, .sensorVoltageBig, true, maxValue: 8.192)
    case .O2Sensor2WRVolatage:
      return CommandProperties(
        "0125", "02 Sensor 2 WR Lambda Voltage", 6, .sensorVoltageBig, true, maxValue: 8.192)
    case .O2Sensor3WRVolatage:
      return CommandProperties(
        "0126", "02 Sensor 3 WR Lambda Voltage", 6, .sensorVoltageBig, true, maxValue: 8.192)
    case .O2Sensor4WRVolatage:
      return CommandProperties(
        "0127", "02 Sensor 4 WR Lambda Voltage", 6, .sensorVoltageBig, true, maxValue: 8.192)
    case .O2Sensor5WRVolatage:
      return CommandProperties(
        "0128", "02 Sensor 5 WR Lambda Voltage", 6, .sensorVoltageBig, true, maxValue: 8.192)
    case .O2Sensor6WRVolatage:
      return CommandProperties(
        "0129", "02 Sensor 6 WR Lambda Voltage", 6, .sensorVoltageBig, true, maxValue: 8.192)
    case .O2Sensor7WRVolatage:
      return CommandProperties(
        "012A", "02 Sensor 7 WR Lambda Voltage", 6, .sensorVoltageBig, true, maxValue: 8.192)
    case .O2Sensor8WRVolatage:
      return CommandProperties(
        "012B", "02 Sensor 8 WR Lambda Voltage", 6, .sensorVoltageBig, true, maxValue: 8.192)
    ...
    case .warmUpsSinceDTCCleared:
      return CommandProperties("0130", "Number of warm-ups since codes cleared", 4, .uas(0x01), true)
    case .distanceSinceDTCCleared:
      return CommandProperties(
        "0131", "Distance traveled since codes cleared", 4, .uas(0x25), true, maxValue: 65535.0)
    case .evapVaporPressure:
      return CommandProperties("0132", "Evaporative system vapor pressure", 4, .evapPressure, true)
    case .barometricPressure:
      return CommandProperties("0133", "Barometric Pressure", 4, .pressure, true, maxValue: 255.0)
    case .O2Sensor1WRCurrent:
      return CommandProperties(
        "0134", "02 Sensor 1 WR Lambda Current", 4, .currentCentered, true, maxValue: 128, minValue: -128)
    case .O2Sensor2WRCurrent:
      return CommandProperties(
        "0135", "02 Sensor 2 WR Lambda Current", 4, .currentCentered, true, maxValue: 128, minValue: -128)
    case .O2Sensor3WRCurrent:
      return CommandProperties(
        "0136", "02 Sensor 3 WR Lambda Current", 4, .currentCentered, true, maxValue: 128, minValue: -128)
    case .O2Sensor4WRCurrent:
      return CommandProperties(
        "0137", "02 Sensor 4 WR Lambda Current", 4, .currentCentered, true, maxValue: 128, minValue: -128)
    case .O2Sensor5WRCurrent:
      return CommandProperties(
        "0138", "02 Sensor 5 WR Lambda Current", 4, .currentCentered, true, maxValue: 128, minValue: -128)
    case .O2Sensor6WRCurrent:
      return CommandProperties(
        "0139", "02 Sensor 6 WR Lambda Current", 4, .currentCentered, true, maxValue: 128, minValue: -128)
    case .O2Sensor7WRCurrent:
      return CommandProperties(
        "013A", "02 Sensor 7 WR Lambda Current", 4, .currentCentered, true, maxValue: 128, minValue: -128)
    case .O2Sensor8WRCurrent:
      return CommandProperties(
        "013B", "02 Sensor 8 WR Lambda Current", 4, .currentCentered, true, maxValue: 128, minValue: -128)
    case .catalystTempB1S1:
      return CommandProperties("013C", "Catalyst Temperature: Bank 1 - Sensor 1", 4, .uas(0x16), true)
    case .catalystTempB2S1:
      return CommandProperties("013D", "Catalyst Temperature: Bank 2 - Sensor 1", 4, .uas(0x16), true)
    case .catalystTempB1S2:
      return CommandProperties("013E", "Catalyst Temperature: Bank 1 - Sensor 2", 4, .uas(0x16), true)
    case .catalystTempB2S2:
      return CommandProperties("013F", "Catalyst Temperature: Bank 1 - Sensor 2", 4, .uas(0x16), true)
    ...
    case .controlModuleVoltage:
      return CommandProperties("0142", "Control module voltage", 4, .uas(0x0B), true)
    case .absoluteLoad: return CommandProperties("0143", "Absolute load value", 4, .percent, true)
    case .commandedEquivRatio:
      return CommandProperties("0144", "Commanded equivalence ratio", 4, .uas(0x1E), true)
    case .relativeThrottlePos:
      return CommandProperties("0145", "Relative throttle position", 4, .percent, true)
    ...
    case .timeSinceDTCCleared:
      return CommandProperties("014E", "Time since trouble codes cleared", 4, .uas(0x34), true)
    case .maxValues: return CommandProperties("014F", "Maximum value for various values", 6, .none)
    case .maxMAF:
      return CommandProperties(
        "0150", "Maximum value for air flow rate from mass air flow sensor", 4, .maxMaf, true)
    ...
    case .evapVaporPressureAbs:
      return CommandProperties("0153", "Absolute Evap system vapor pressure", 4, .evapPressureAlt, true)
    case .evapVaporPressureAlt:
      return CommandProperties("0154", "Evap system vapor pressure", 4, .evapPressureAlt, true)
    case .shortO2TrimB1:
      return CommandProperties("0155", "Short term secondary O2 trim - Bank 1", 4, .percentCentered, true)
    case .longO2TrimB1:
      return CommandProperties("0156", "Long term secondary O2 trim - Bank 1", 4, .percentCentered, true)
    case .shortO2TrimB2:
      return CommandProperties("0157", "Short term secondary O2 trim - Bank 2", 4, .percentCentered, true)
    case .longO2TrimB2:
      return CommandProperties("0158", "Long term secondary O2 trim - Bank 2", 4, .percentCentered, true)
    case .fuelRailPressureAbs:
      return CommandProperties("0159", "Fuel rail pressure (absolute)", 4, .uas(0x1B), true)
    case .relativeAccelPos:
      return CommandProperties("015A", "Relative accelerator pedal position", 3, .percent, true)
    case .hybridBatteryLife:
      return CommandProperties("015B", "Hybrid battery pack remaining life", 3, .percent)
    case .engineOilTemp:
      return CommandProperties("015C", "Engine oil temperature", 2, .temp, true, maxValue: 210)
    case .fuelInjectionTiming:
      return CommandProperties("015D", "Fuel injection timing", 4, .injectTiming, true)
...
extension OBDCommand.Mode6 {
  var properties: CommandProperties {
    ...
    case .MONITOR_O2_B1S1:
      return CommandProperties("0601", "O2 Sensor Monitor Bank 1 - Sensor 1", 0, .monitor)
    case .MONITOR_O2_B1S2:
      return CommandProperties("0602", "O2 Sensor Monitor Bank 1 - Sensor 2", 0, .monitor)
    case .MONITOR_O2_B1S3:
      return CommandProperties("0603", "O2 Sensor Monitor Bank 1 - Sensor 3", 0, .monitor)
    case .MONITOR_O2_B1S4:
      return CommandProperties("0604", "O2 Sensor Monitor Bank 1 - Sensor 4", 0, .monitor)
    case .MONITOR_O2_B2S1:
      return CommandProperties("0605", "O2 Sensor Monitor Bank 2 - Sensor 1", 0, .monitor)
    case .MONITOR_O2_B2S2:
      return CommandProperties("0606", "O2 Sensor Monitor Bank 2 - Sensor 2", 0, .monitor)
    case .MONITOR_O2_B2S3:
      return CommandProperties("0607", "O2 Sensor Monitor Bank 2 - Sensor 3", 0, .monitor)
    case .MONITOR_O2_B2S4:
      return CommandProperties("0608", "O2 Sensor Monitor Bank 2 - Sensor 4", 0, .monitor)
    case .MONITOR_O2_B3S1:
      return CommandProperties("0609", "O2 Sensor Monitor Bank 3 - Sensor 1", 0, .monitor)
    case .MONITOR_O2_B3S2:
      return CommandProperties("060A", "O2 Sensor Monitor Bank 3 - Sensor 2", 0, .monitor)
    case .MONITOR_O2_B3S3:
      return CommandProperties("060B", "O2 Sensor Monitor Bank 3 - Sensor 3", 0, .monitor)
    case .MONITOR_O2_B3S4:
      return CommandProperties("060C", "O2 Sensor Monitor Bank 3 - Sensor 4", 0, .monitor)
    case .MONITOR_O2_B4S1:
      return CommandProperties("060D", "O2 Sensor Monitor Bank 4 - Sensor 1", 0, .monitor)
    case .MONITOR_O2_B4S2:
      return CommandProperties("060E", "O2 Sensor Monitor Bank 4 - Sensor 2", 0, .monitor)
    case .MONITOR_O2_B4S3:
      return CommandProperties("060F", "O2 Sensor Monitor Bank 4 - Sensor 3", 0, .monitor)
    case .MONITOR_O2_B4S4:
      return CommandProperties("0610", "O2 Sensor Monitor Bank 4 - Sensor 4", 0, .monitor)
    ...
    case .MONITOR_O2_HEATER_B1S1:
      return CommandProperties("0641", "O2 Sensor Heater Monitor Bank 1 - Sensor 1", 0, .monitor)
    case .MONITOR_O2_HEATER_B1S2:
      return CommandProperties("0642", "O2 Sensor Heater Monitor Bank 1 - Sensor 2", 0, .monitor)
    case .MONITOR_O2_HEATER_B1S3:
      return CommandProperties("0643", "O2 Sensor Heater Monitor Bank 1 - Sensor 3", 0, .monitor)
    case .MONITOR_O2_HEATER_B1S4:
      return CommandProperties("0644", "O2 Sensor Heater Monitor Bank 1 - Sensor 4", 0, .monitor)
    case .MONITOR_O2_HEATER_B2S1:
      return CommandProperties("0645", "O2 Sensor Heater Monitor Bank 2 - Sensor 1", 0, .monitor)
    case .MONITOR_O2_HEATER_B2S2:
      return CommandProperties("0646", "O2 Sensor Heater Monitor Bank 2 - Sensor 2", 0, .monitor)
    case .MONITOR_O2_HEATER_B2S3:
      return CommandProperties("0647", "O2 Sensor Heater Monitor Bank 2 - Sensor 3", 0, .monitor)
    case .MONITOR_O2_HEATER_B2S4:
      return CommandProperties("0648", "O2 Sensor Heater Monitor Bank 2 - Sensor 4", 0, .monitor)
    case .MONITOR_O2_HEATER_B3S1:
      return CommandProperties("0649", "O2 Sensor Heater Monitor Bank 3 - Sensor 1", 0, .monitor)
    case .MONITOR_O2_HEATER_B3S2:
      return CommandProperties("064A", "O2 Sensor Heater Monitor Bank 3 - Sensor 2", 0, .monitor)
    case .MONITOR_O2_HEATER_B3S3:
      return CommandProperties("064B", "O2 Sensor Heater Monitor Bank 3 - Sensor 3", 0, .monitor)
    case .MONITOR_O2_HEATER_B3S4:
      return CommandProperties("064C", "O2 Sensor Heater Monitor Bank 3 - Sensor 4", 0, .monitor)
    case .MONITOR_O2_HEATER_B4S1:
      return CommandProperties("064D", "O2 Sensor Heater Monitor Bank 4 - Sensor 1", 0, .monitor)
    case .MONITOR_O2_HEATER_B4S2:
      return CommandProperties("064E", "O2 Sensor Heater Monitor Bank 4 - Sensor 2", 0, .monitor)
    case .MONITOR_O2_HEATER_B4S3:
      return CommandProperties("064F", "O2 Sensor Heater Monitor Bank 4 - Sensor 3", 0, .monitor)
    case .MONITOR_O2_HEATER_B4S4:
      return CommandProperties("0650", "O2 Sensor Heater Monitor Bank 4 - Sensor 4", 0, .monitor)
    case .MIDS_D: return CommandProperties("0660", "Supported MIDs [61-80]", 0, .pid)
    case .MONITOR_HEATED_CATALYST_B1:
      return CommandProperties("0661", "Heated Catalyst Monitor Bank 1", 0, .monitor)
    case .MONITOR_HEATED_CATALYST_B2:
      return CommandProperties("0662", "Heated Catalyst Monitor Bank 2", 0, .monitor)
    case .MONITOR_HEATED_CATALYST_B3:
      return CommandProperties("0663", "Heated Catalyst Monitor Bank 3", 0, .monitor)
    case .MONITOR_HEATED_CATALYST_B4:
      return CommandProperties("0664", "Heated Catalyst Monitor Bank 4", 0, .monitor)
    ...
    case .MONITOR_BOOST_PRESSURE_B1:
      return CommandProperties("0685", "Boost Pressure Control Monitor Bank 1", 0, .monitor)
    case .MONITOR_BOOST_PRESSURE_B2:
      return CommandProperties("0686", "Boost Pressure Control Monitor Bank 1", 0, .monitor)
    case .MONITOR_NOX_ABSORBER_B1:
      return CommandProperties("0690", "NOx Absorber Monitor Bank 1", 0, .monitor)
    case .MONITOR_NOX_ABSORBER_B2:
      return CommandProperties("0691", "NOx Absorber Monitor Bank 2", 0, .monitor)
    case .MONITOR_NOX_CATALYST_B1:
      return CommandProperties("0698", "NOx Catalyst Monitor Bank 1", 0, .monitor)
    case .MONITOR_NOX_CATALYST_B2:
      return CommandProperties("0699", "NOx Catalyst Monitor Bank 2", 0, .monitor)
    case .MIDS_F: return CommandProperties("06A0", "Supported MIDs [A1-C0]", 0, .pid)
    case .MONITOR_MISFIRE_GENERAL:
      return CommandProperties("06A1", "Misfire Monitor General Data", 0, .monitor)
    ...
    case .MONITOR_MISFIRE_CYLINDER_10:
      return CommandProperties("06AB", "Misfire Cylinder 10 Data", 0, .monitor)
    case .MONITOR_MISFIRE_CYLINDER_11:
      return CommandProperties("06AC", "Misfire Cylinder 11 Data", 0, .monitor)
    case .MONITOR_MISFIRE_CYLINDER_12:
      return CommandProperties("06AD", "Misfire Cylinder 12 Data", 0, .monitor)
